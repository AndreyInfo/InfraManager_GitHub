requirejs.config({
    ...
    paths: {
        ...
        signalRHubs: '/microsoft/signalr/dist/webworker/signalr.min',
        ...
        restApiTree: 'controls/restApiTree',
        restApiTreeControl: 'controls/restApiTreeControl',
        organizationStructureTree: 'controls/organizationStructureTree',
        organizationStructureTreeControl: 'controls/organizationStructureTreeControl',
        divisionStructureTree: 'controls/divisionStructureTree',
        workplaceStructureTree: 'controls/workplaceStructureTree',
        productCatalogTree: 'controls/productCatalogTree',
        workOrderTypesTree: 'controls/workOrderTypesTree',
        ...
        //
        fpJs: 'vendor/fp.min',
        fingerPrintLib: 'utility/fingerPrintLib',
        showEntityService: 'utility/showEntityService',
        groupOperation: 'utility/groupOperation',
        dynamicOptionsService: 'utility/dynamicOptionsService'
    },
    shim: {
        modernizr: {
            exports: 'Modernizr'
