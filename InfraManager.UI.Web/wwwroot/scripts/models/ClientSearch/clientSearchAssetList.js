                    ...
                    {//geting data             
                        ...
                        self.getObjectList = function () {
                            ...
                            var requestInfo = {
                                StartRecordIndex: 0,
                                CountRecords: 0,
                                ClientID: self.userIDSearch ? self.userIDSearch : null,
                            ...
                            self.ajaxControl.Ajax(null,
                                {
                                    method: 'GET',
                                    data: requestInfo,
                                    url: '/api/Hardwares/Reports/ClientsHardware',
                                },
                                function (newVal) {
                                    if (newVal) {
                                        if (newVal.length === 0 && !self.IsExpandedCheck())
