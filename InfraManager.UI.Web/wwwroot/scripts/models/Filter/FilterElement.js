        ...
        ViewModel: function (filterMainModel, $container) {
            ...
            self.LoadFullList = function () {
                ...
                $.when(self.filterMainModel.currentTableView()).done(function (curViewInfo) {
                    ...
                    //                    
                    var url = module.MigratedViews.includes(curViewInfo.view)
                        ? '/api/availablefilterelements/' + param.viewName
                        : '/filterApi/GetFilterElementsList?' + $.param(param);
            ...
            self.LoadElement = function (propertyName) {
                ...
                $.when(self.filterMainModel.currentTableView()).done(function (curViewInfo) {
                    ...
                    var url = module.MigratedViews.includes(param.viewName)
                        ? '/api/availableFilterElements/' + param.viewName + '/' + param.propertyName
                        : '/filterApi/GetFilterElement?' + $.param(param);
                    ajx.Ajax(null,
                            {
                                dataType: "json",
                                method: 'GET',
            ...
            self.LoadElementsByFilter = function (filterID) {
                ...
                $.when(self.filterMainModel.currentTableView()).done(function (curViewInfo) {
                    ...
                    self.ajaxControl_loadElementsByFilter.Ajax($('.b-content-table__filter-container'),
                        {
                            url: '/api/filters/' + param.filterId,
                            method: 'GET'
                        },
                        function (filter) {
                            var filterListWithData = filter.Elements;
