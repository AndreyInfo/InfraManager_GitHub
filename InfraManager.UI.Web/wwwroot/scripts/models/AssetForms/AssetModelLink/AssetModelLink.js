            ...
            ViewModel: function ($region, activeRequestMode, hasLifeCycleOnly, modelSearchMode, productCatalogueItemInfo) {
                ...
                {//tab helpers
                    ...
                    self.isTabContractVisible = ko.computed(function () {
                        return productCatalogueItemInfo?.showContractTab === false ? false : !modelSearchMode;
                    });
                ...
                {//tabModel
                    ...
                    self.lv_tabModel = new module.ListView(
                        productCatalogueItemInfo?.listName ? productCatalogueItemInfo.listName : 'AssetModelSearch',
                        productCatalogueItemInfo?.url ? productCatalogueItemInfo.url : '/imApi/GetAssetModelSearchListForTable',
                    ...
                    self.treeFilterCheck_Model = function () {
                        ...
                        if (!self.tv_Model) {
                            ...
                            self.tv_Model.init($tv, 2, {
                                ...
                                AvailableTemplateID: productCatalogueItemInfo ? productCatalogueItemInfo.TemplateID : null,
                    ...
                    {//geting data             
                        ...
                        self.getObjectList = function (startRecordIndex, countOfRecords, idArray, showErrors) {
                            ...
                            var requestInfo = {
                                ...
                                TemplateID: productCatalogueItemInfo ? productCatalogueItemInfo.TemplateID : null,
                            };
