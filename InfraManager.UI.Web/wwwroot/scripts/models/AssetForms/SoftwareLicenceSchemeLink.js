define(['knockout',
    ...
    function (ko,
        ...
        var module = {
            MaxCount: 1000000,
            ViewModel: function ($region, activeRequestMode, hasLifeCycleOnly, modelSearchMode, productCatalogueItemInfo, rowClockCallback) {
                var self = this;
                ...
                {//tabModel
                    ...
                    self.lv_tabModel = new module.ListView(
                        'SoftwareLicenceSchemeSelect',
                        'SoftwareLicenceSchemes',
                    ...
                    {//geting data 
                        ...
                        self.getObjectList = function (startRecordIndex, countOfRecords, idArray, showErrors) {
                            ...
                            var requestInfo = {
                                ...
                                SortListName:'SoftwareLicenceSchemeSelect'
                            };
                                ...
                                function (newVal) {
                                    if (newVal && newVal.Result === 0) {
                                        ...
                                        require(['sweetAlert'], function () {
                                            swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[SoftwareLicenceSchemeLink.js getObjectList]', 'error');
                                        });
                                    }
            ...
            ResultObject: function (obj) {
                ...
                self.IsLocationRestrictionApplicable = obj.IsLocationRestrictionApplicable;
                self.Note = obj.Note;
            }
        }
        return module;
