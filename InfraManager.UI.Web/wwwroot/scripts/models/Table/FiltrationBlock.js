                ...
                self.ajaxControl_save.Ajax(null,
                    {
                        ...
                        data: JSON.stringify(
                        {
                            AssetFiltrationObjectID: self.SelectedObjectID(),
                            AssetFiltrationObjectClassID: self.SelectedObjectClassID(),
                            AssetFiltrationObjectName: self.SelectedObjectName(),
                            AssetFiltrationTreeType: self.SelectedInModeConverted(),
                            AssetFiltrationField: self.SelectedField() ? self.SelectedField().ID : ''
                        }),
                        method: 'POST'
                    },
                    function (response) {
