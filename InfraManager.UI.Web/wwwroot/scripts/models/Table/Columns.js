    ...
    var module = {
        ViewModel: function (tableModel, $regionColumnsPanel, $regionColumnsButton, $regionWorkspace) {
            ...
            self.SaveColumnsPrivate = function () {
                ...
                ]; // TODO: remove migratedViews after all lists are migrated

                if (migratedViews.includes(tableModel.viewName)) {
                    var param = [];
                    try {
                        self.columnList().forEach(function (obj) {
                    ...
                    self.ajaxControl.Ajax(null,
                        {
                            url: '/api/ColumnSettings/' + tableModel.viewName,
                            method: 'POST',
                            dataType: "text",
                ...
                } else { // TODO: remove this else { ... } block after all lists are migrated
