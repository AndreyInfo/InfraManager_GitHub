define(['knockout', 'jquery', 'ajax', 'usualForms', 'dateTimeControl', 'comboBox'], function (ko, $, ajaxLib, fhModule, dtLib) {
    var module = {
        ViewModel: function (obj) {
            ...
            //
            self.periodStart = ko.observable(obj.UtcPeriodStartDT() ? obj.UtcPeriodStartDT() : null);//always local string
            ...
            //
            self.periodEnd = ko.observable(obj.UtcPeriodEndDT() ? obj.UtcPeriodEndDT() : null);//always local string
