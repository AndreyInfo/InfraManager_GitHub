define(['knockout', 'jquery', 'models/SDForms/SDForm.User'], function (ko, $, userLib) {
    var module = {
        WorkOrderReference: function (imList, obj) {
            ...
            //
            wself.ID = obj.ID;            
            wself.ReferenceID = obj.WorkOrderReferenceID;
            wself.Uri = obj.Uri;
            //
            ...
            //
            if (obj.ManHours)
                wself.ManHours = ko.observable(obj.ManHoursString)
            else wself.ManHours = ko.observable('');
            //
            if (obj.ManhoursNorm)
                wself.ManhoursNorm = ko.observable(obj.ManhoursNormString)
            ...
            wself.Merge = function (newValue) {
                ...
                wself.ManHours(newValue.ManHours || newValue.ManHoursString)
                wself.ManhoursNorm(newValue.ManhoursNorm || newValue.ManHoursNormString)
