define(['knockout', 'jquery', 'models/SDForms/SDForm.User'], function (ko, $, userLib) {
    var module = {
        ProblemReference: function (imList, obj) {
            ...
            //
            pself.InitiatorID = (obj.InitiatorID) ? ko.observable(obj.InitiatorID) : pself.InitiatorID = ko.observable('');
            //
            if (obj.OwnerName)
            ...
            let options = {
                UserID: pself.InitiatorID(),
                UserType: userLib.UserTypes.workInitiator,
                UserName: '',
                EditAction: null,
                RemoveAction: null
            };
            pself.InitiatorObj = pself.InitiatorID() !== '' ? ko.observable(new userLib.User(pself, options)) : ko.observable(null);
            options = {
            ...
            pself.OwnerObj = pself.OwnerID() !== '' ? ko.observable(new userLib.User(pself, options)) : ko.observable(null);
            //
