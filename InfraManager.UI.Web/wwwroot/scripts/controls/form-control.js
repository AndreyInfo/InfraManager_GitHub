define(['knockout', 'jquery', 'ajax', 'jqueryUI'], function (ko, $, ajaxLib) {
    var module = {
        ...
        control: function (regionName, formName, caption, isModal, isDraggable, isResizable, minWidth, minHeight, buttons, afterClose, attrs, libsParams = {}) {
            var self = this;
            self.Initialized = false;
            self.libsParams = libsParams;
            ...
            self.Opened = function () {
                ...
                if (self.libsParams.maxWidth) {
                    parentDiv.css({
                        maxWidth: libsParams.maxWidth + 'px',
                        left: '50%',
                        transform: 'translateX(-50%)'
                    });
                };

                if (self.libsParams.maxHeight) {
                    parentDiv.css('maxHeight', libsParams.maxHeight + 'px');
                };
