define(['knockout',
    ...
    './templateParamsUpdate/UpdateCharacteristics(UpdateReadOnly)'
],
    function (ko,
        $,
        ajaxLib,
        ...
        var module = {
            ...
            ShowDialog: function (selectedObjects, operationName, lifeCycleStateOperationID, isSpinnerActive) {
                ...
                $.when(userD).done(function (user) {
                    ...
                    frm = new fc.control(
                        'frmLicenceUpdate',//form region prefix
                        'frmLicenceUpdate_setting',//location and size setting
                        ...
                        'data-bind="template: {name: \'../UI/Forms/Asset/AssetOperations/frmLicenceUpdateReadOnly\', afterRender: AfterRender}"'//attributes of form region
                    );
                    //
                    if (!frm.Initialized)
