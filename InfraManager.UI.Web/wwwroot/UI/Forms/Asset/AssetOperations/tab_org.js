define(['knockout', 'jquery', 'ajax', 'treeControl', 'ui_controls/ListView/ko.ListView.Cells'], function (ko, $, ajaxLib, treeLib, mCells) {
    var module = {
        Tab: function(vm) {
            ...
            self.Template = '../UI/Forms/Asset/AssetOperations/tab_org';
            ...
            self.load = function () {
                ...
                self.InitOrgStructureTree = function () {
                    vm.orgStructureControl(new treeLib.control());
                    vm.orgStructureControl().init($('#regionOrgStructure2 .regionFilterTree-orgstructure-tree2'), 0, {
                    ...
                    //
                    $.when(vm.orgStructureControl().$isLoaded).done(function () {
