define(['knockout',
    ...
    './templateParamsUpdate/UpdateCharacteristics(UpgradeReadOnly)'
],
    function (ko,
        $,
        ajaxLib,
            ...
            ShowDialog: function (selectedObjects, operationName, lifeCycleStateOperationID, isSpinnerActive) {
                ...
                $.when(userD).done(function (user) {
                    ...
                    frm = new fc.control(
                        ...
                        'data-bind="template: {name: \'../UI/Forms/Asset/AssetOperations/frmLicenceUpgradeReadOnly\', afterRender: AfterRender}"'//attributes of form region
                    );
                    //
                    if (!frm.Initialized)
