    ...
    function (ko, $, ajaxLib, dtLib, fhModule, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            List: function (vm) {
                ...
                //
                self.obj = vm.cluster ? vm.cluster : vm.configurationUnit;
                //
                self.isOperationeClusterAdd = ko.observable(false);
                self.isOperationConfigurationUnitUpdate = ko.observable(false);
                //
                self.Template = '../UI/Forms/Asset/ClusterVMForTable';
                //when tab unload
                ...
                {//identification      
                    ...
                    self.isObjectClassVisible = function (classID) {
                        return classID == 415 ||
                            classID == 416 ||
                            classID == 417 ||
                            classID == 418 ||
                ...
                {//contextMenu
                    ...
                    {//granted operations
                        ...
                        $.when(userD).done(function (user) {
                            ...
                            self.isOperationConfigurationUnitUpdate(self.operationIsGranted(953));
                        });
                    }
                    //
                ...
                //
                self.createLogicObject = function () {
                    if (self.isOperationeClusterAdd() == true || self.isOperationConfigurationUnitUpdate() == true) {
                        require(['assetForms'], function (module) {
                            var fh = new module.formHelper(true);
                            fh.ShowLogicalObjectRegistrationForm(self.obj, self.listView.load);
                        });
                    }
                    else return;
                };
                ...
                //
                self.ajaxControl_ClusterVM = new ajaxLib.control();
                //
                self.addVM = function () {
                    if (self.isOperationConfigurationUnitUpdate() == false)
                        return;
                    //
                    require(['assetForms'], function (fhModule) {
                        ...
                        fh.ShowAssetLink({
                            ...
                            IsHostClusterForm: false,
                            IsVMClusterForm: true
            ...
            //
                ...
                {//geting data             
                    ...
                    //
                    self.viewName = 'ClusterVMForTable';
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetClusterVMForTable'
                            },
                            function (newVal) {
                                if (newVal && newVal.Result === 0) {
                                    ...
                                    require(['sweetAlert'], function () {
                                        swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[ClusterVMForTable.js getObjectList]', 'error');
                                    });
                                }
