    ...
    function (ko, $, ajaxLib, dtLib, fhModule, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            List: function (vm) {
                ...
                //
                self.obj = vm.LogicalObject;
                //
                self.Template = '../UI/Forms/Asset/LogicObjectComponentsForTable';
                //when tab unload
                ...
                //
                self.ajaxControl_SoftwareModelLicensesForTable = new ajaxLib.control();
                //
                {//geting data             
                    ...
                    //
                    self.viewName = 'LogicObjectComponents';
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetLogicObjectComponentsForTable'
                            },
                            function (newVal) {
                                if (newVal && newVal.Result === 0) {
                                    ...
                                    require(['sweetAlert'], function () {
                                        swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[LogicObjectComponentsForTable.js getObjectList]', 'error');
                                    });
                                }
