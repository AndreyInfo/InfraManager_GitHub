    ...
    function (ko, $, ajaxLib, dtLib, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            List: function (vm) {
                ...
                //
                self.Template = '../UI/Forms/Asset/DataEntityDependencyListForTable';
                //when tab unload
                ...
                {//geting data             
                    ...
                    //
                    self.viewName = 'DataEntityDependencyList';
                    self.getObjectList = function (idArray, showErrors) {
                        ...
                        var requestInfo = {
                            ...
                            ParentObjectID: vm.DataEntityObject().ID()
                        };
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetDataEntityDependencyListForTable'
                            },
                            function (newVal) {
                                if (newVal && newVal.Result === 0) {
                                    ...
                                    require(['sweetAlert'], function () {
                                        swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[DataEntityDependency.js getObjectList]', 'error');
                                    });
                                }
