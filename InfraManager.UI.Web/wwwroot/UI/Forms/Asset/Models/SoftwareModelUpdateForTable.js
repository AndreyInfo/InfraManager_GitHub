    ...
    function (ko, $, ajaxLib, dtLib, fhModule, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            List: function (vm) {
                ...
                //
                self.Template = '../UI/Forms/Asset/Models/SoftwareModelUpdateForTable';
                //when tab unload
                ...
                //
                self.ajaxControl_SoftwareModelUpdateForTable = new ajaxLib.control();
                //
                {//geting data             
                    ...
                    //
                    self.viewName = 'SoftwareModelUpdateForTable';
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetSoftwareModelUpdateForTable'
                            },
                            function (newVal) {
                                if (newVal && newVal.Result === 0) {
                                    ...
                                    require(['sweetAlert'], function () {
                                        swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[SoftwareModelUpdateForTable.js getObjectList]', 'error');
                                    });
                                }
