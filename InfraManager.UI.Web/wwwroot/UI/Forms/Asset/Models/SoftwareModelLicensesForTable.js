    ...
    function (ko, $, ajaxLib, dtLib, fhModule, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            List: function (vm) {
                ...
                //
                self.Template = '../UI/Forms/Asset/Models/SoftwareModelLicensesForTable';
                //when tab unload
                ...
                {//geting data             
                    ...
                    //
                    self.viewName = 'SoftwareModelLicensesForTable';
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetSoftwareModelLicensesForTable'
                            },
                            function (newVal) {
                                if (newVal && newVal.Result === 0) {
                                    ...
                                    require(['sweetAlert'], function () {
                                        swal(getTextResource('ErrorCaption'), getTextResource('NullParamsError') + '\n[SoftwareModelLicensesForTable.js getObjectList]', 'error');
                                    });
                                }
