    ...
    function (ko, $, ajaxLib, dtLib, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            Tab: function (vm) {
                ...
                self.Template = '../UI/Forms/Asset/Contracts/frmContract_licenceMaintenanceListTab';
                ...
                {//identification      
                    ...
                    self.isObjectClassVisible = function (objectClassID) {
                        return objectClassID == 390;//OBJ_ServiceContractLicenceMaintenance
                    };
                }
                    ...
                    self.getItemInfos = function (items) {
                        ...
                        items.forEach(function (item) {
                            retval.push({
                                ...
                                ClassID: 390 //OBJ_ServiceContractLicenceMaintenance
                            });
                        });
                        return retval;
                    };
                            ...
                            require(['usualForms'], function (module) {
                                ...
                                var options = {
                                    ...
                                    onSave: function (newDate) {
                                        selected.forEach(function (item) {
                                            $(document).trigger('local_objectUpdated', [390, item.ID]);
                                        });
                                    }
                                };
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetLicenceMaintenanceObject'
                            },
                            function (newVal) {
