    ...
    function (ko, $, ajaxLib, dtLib, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            Tab: function (vm) {
                ...
                //
                self.Name = getTextResource('Contract_LicenceMaintenanceListTab');
                self.Template = '../UI/Forms/Asset/Contracts/frmAgreement_licenceMaintenanceListTab';
                ...
                self.init = function (obj) {
                    self.IsVisible(obj.IsLicenceMainteinanceTabVisible());
                };
                //when tab selected
                self.load = function () {
                    if (!vm.object().IsUpdateOptionsAvailable())
                        self.canMaintenanceAdd(false);
                    if (vm.object().IsRentOptionsAvailable())
                        self.canMaintenanceAdd(false);
                };
                //when tab validating
                ...
                {//identification      
                    ...
                    self.isObjectClassVisible = function (objectClassID) {
                        return objectClassID == 343;//OBJ_ServiceContractLicenceMaintenance
                    };
                }
                //
                {//contextMenu
                    {//granted operations
                        ...
                        $.when(userD).done(function (user) {
                            ...
                            //
                            self.canMaintenanceAdd(self.operationIsGranted(441) && //OPERATION_SOFTWARELICENCE_PROPERTIES
                                self.operationIsGranted(881));  //OPERATION_ServiceContractMaintenance_Add
                        });
                    }
                    //
                    ...
                    self.addMaintenance = function () {
                        require(['assetForms'], function (fhModule) {
                                ...
                                self.ajaxControl.Ajax(null,
                                    {
                                        ...
                                        method: 'POST',
                                        data: data,
                                        url: '/assetApi/AddAgreementMaintenance'
                                    },
                                    function (model) {
                                        if (model.Result === 0) {
                                        }
                            ...
                            //
                            fh.ShowSoftwareLicenceLink(saveFunc);
                        });
                    };

                    self.add = function (contextMenu) {
                        var isEnable = function () {
                            if (!self.canMaintenanceAdd())
                                return false;
                            return true;
                        };
                        var isVisible = function () {
                            return self.operationIsGranted(441) //OPERATION_SOFTWARELICENCE_PROPERTIES
                                && self.operationIsGranted(881) //OPERATION_ServiceContractMaintenance_Add
                                && vm.canEdit();
                        };
                        //
                    ...
                    self.getItemInfos = function (items) {
                        ...
                        items.forEach(function (item) {
                            retval.push({
                                ...
                                ClassID: 343 //OBJ_ServiceContractLicenceMaintenance
                            });
                        });
                        return retval;
                    };
                    ...
                    self.remove = function (contextMenu) {
                        ...
                        var isVisible = function () {
                            return self.operationIsGranted(882) && vm.canEdit();//OPERATION_ServiceContractMaintenance_Delete
                        };
                        var action = function () {
                    ...
                    self.maintenanceFinish = function (contextMenu) {
                        ...
                        var isVisible = function () {
                            return false;
                            //return self.operationIsGranted(883) && vm.canEdit();//OPERATION_ServiceContractMaintenance_Update
                        };
                        var action = function () {
                            var selected = self.getSelectedItems();
                            var objectList = [];
                            ...
                            require(['usualForms'], function (module) {
                                ...
                                var options = {
                                    ...
                                    onSave: function (newDate) {
                                        selected.forEach(function (item) {
                                            $(document).trigger('local_objectUpdated', [343, item.ID]);
                                        });
                                    }
                                };
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetLicenceMaintenanceObjectForAgreement'
                            },
                            function (newVal) {
                ...
                {//open object form
                    self.showObjectForm = function (serviceContractID, objectID, objectClassID) {
                        ...
                        require(['assetForms'], function (module) {
                            var fh = new module.formHelper(true);
                            fh.ShowContractMaintenance(serviceContractID, objectID, objectClassID);
                        });
                    };
                }
                //            
