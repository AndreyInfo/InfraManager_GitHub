    ...
    function (ko, $, ajaxLib, dtLib, m_cells, m_helpers, m_lazyEvents) {
        var module = {
            Tab: function (vm) {
                ...
                self.Template = '../UI/Forms/Asset/Contracts/frmAgreement_assetMaintenanceListTab';
                ...
                {//events of listView
                    ...
                    self.listViewRowClick = function (obj) {
                        ...
                        if (obj.ObjectClassID == 6)//OBJ_TERMINALDEVICE
                            tmp = self.operationIsGranted(65); //OPERATION_PROPERTIES_TERMINALDEVICE
                        if (obj.ObjectClassID == 5)//OBJ_NETWORKDEVICE
                            tmp = self.operationIsGranted(23); //OPERATION_PROPERTIES_NETWORKDEVICE
                        if (obj.ObjectClassID == 33)//OBJ_ADAPTER
                            tmp = self.operationIsGranted(77); //OPERATION_PROPERTIES_ADAPTER
                        if (obj.ObjectClassID == 34)//OBJ_PERIPHERAL
                            tmp = self.operationIsGranted(79)
                        if(tmp)
                ...
                {//contextMenu
                    ...
                    self.add = function (contextMenu) {
                        ...
                        var isVisible = function () {
                            return self.operationIsGranted(881) && vm.canEdit();//OPERATION_ServiceContractMaintenance_Add
                        };
                    ...
                    self.remove = function (contextMenu) {
                        ...
                        var isVisible = function () {
                            return self.operationIsGranted(882) && vm.canEdit();
                        };
                        var action = function () {
                                            ...
                                            self.ajaxControl.Ajax(null,
                                                ...
                                                function (newVal) {
                                                    data.ObjectList.forEach(function (info) {
                                                        $(document).trigger('Agreement_local_objectDeleted', [info.ClassID, info.ID]);
                                                    });
                                                    self.clearSelection();
                                                });
                                        }
                            ...
                            require(['usualForms'], function (module) {
                                ...
                                var options = {
                                    ...
                                    onSave: function (newDate) {
                                        selected.forEach(function (item) {
                                            $(document).trigger('local_objectUpdated', [369, item.ID]);
                                        });
                                    }
                                };
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetAssetMaintenanceObjectForAgreement'
                            },
                            function (newVal) {
