            ...
            LinkList: function (vm) {
                ...
                {//identification      
                    ...
                    self.isObjectClassVisible = function (objectClassID) {
                        return objectClassID == 34;//OBJ_PERIPHERAL
                    };
                }
                //
                {//contextMenu
                        ...
                        if (contextMenuItem.LifeCycleStateOperationID) {
                            if (contextMenuItem.CommandType == 7) {//asset from storage
                                ...
                                require(['assetForms'], function (module) {
                                    ...
                                    fh.ShowAssetMoveForm(parent, contextMenuItem.Name, contextMenuItem.LifeCycleStateOperationID, contextMenuItem.CommandType, 34);
                                });
                            }
                    ...
                    self.add = function (contextMenu) {
                        ...
                        var isVisible = function () {
                            return self.operationIsGranted(85) && vm.CanEdit();//OPERATION_ADD_PERIPHERAL
                        };
                        var action = function () {
                            showSpinner();
                            require(['assetForms'], function (module) {
                                var fh = new module.formHelper(true);
                                fh.ShowAssetRegistrationForm(34, vm.asset);
                            });
                        };
                        //
                        var cmd = contextMenu.addContextMenuItem();
                    ...
                    self.remove = function (contextMenu) {
                        ...
                        var isVisible = function () {
                            return self.operationIsGranted(80) && vm.CanEdit();//OPERATION_DELETE_PERIPHERAL
                        };
                        var action = function () {
                        ...
                        self.ajaxControl.Ajax(null,
                            {
                                ...
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetPeripheralReferenceObject'
                            },
                            function (newVal) {
