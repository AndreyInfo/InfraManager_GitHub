                ...
                {//geting data             
                    ...
                    self.getObjectList = function (startRecordIndex, countOfRecords, idArray, showErrors) {
                        ...
                        var requestInfo = {
                            ...
                            ProductTypeID: vm.FilterProductCatalogTypeID ? vm.FilterProductCatalogTypeID : null,
                            SoftwareLicenceSchemeID : vm.SoftwareLicenceSchemeID,
                            SoftwareModel : vm.softwareModel ? vm.softwareModel : null,
                            ManufacturerName : vm.ManufacturerName ? vm.ManufacturerName : null,
                            LicenceType : vm.LicenceType ?  vm.LicenceType : null                            
                        };
                        self.ajaxControl.Ajax(null,
                            {
                                dataType: "json",
                                method: 'POST',
                                data: requestInfo,
                                url: '/assetApi/GetSoftwareLicenceObjectForTable'
                            },
                            function (newVal) {
