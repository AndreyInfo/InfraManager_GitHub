define(['knockout', 'jquery', 'ajax', 'formControl',
    './SoftwareLicence',
    './frmSoftwareLicenceAddByContract_generalTab',
    './frmSoftwareLicenceAddByContract_attachmentsTab',
        ...
        var module = {
            ViewModel: function ($region) {
                ...
                self.validate = function () {
                    ...
                    if (!self.object().ProductCatalogTypeID()) {
                        require(['sweetAlert'], function () {
                            swal(getTextResource('SoftwareLicenceAdd_SoftwareLicenceTypeShouldBeSet'));
                        });
                        return false;
                    }

                    if (!self.object().SoftwareModelID()) {
                        require(['sweetAlert'], function () {
                            swal(getTextResource('SoftwareLicenceAdd_SoftwareModelShouldBeSet'));
                        });
                        return false;
                    }
            ...
            ShowDialog: function (isSpinnerActive) {
                ...
                frm = new formControl.control(
                    'region_frmSoftwareLicenceAddByContract_',//form region prefix
                    'setting_frmSoftwareLicenceAddByContract_',//location and size setting
                    ...
                    'data-bind="template: {name: \'../UI/Forms/Asset/SoftwareLicence/frmSoftwareLicenceAddByContract\', afterRender: afterRender}"'//attributes of form region
                );
