define(['knockout', 'jquery', 'ajax'], function (ko, $, ajax) {
    var module = {
        Tab: function (vm) {
            var self = this;
            //
            self.Name = getTextResource('SoftwareLicence_AttachmentListTab');
            self.Template = '../UI/Forms/Asset/SoftwareLicence/frmSoftwareLicenceAddByContract_attachmentsTab';
