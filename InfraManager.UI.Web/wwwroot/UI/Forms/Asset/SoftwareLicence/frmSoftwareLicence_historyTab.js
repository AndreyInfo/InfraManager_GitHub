define(['knockout', 'jquery', 'ajax'], function (ko, $, ajax) {
    var module = {
        Tab: function (vm) {
            ...
            //
            self.Name = getTextResource('SoftwareLicence_HistoryTab');
            self.Template = '../UI/Forms/Asset/SoftwareLicence/frmSoftwareLicence_historyTab';
                            ...
                            if (newVal && newVal.Result === 0) {
                                ...
                                if (list) {
                                    ...
                                    require(['sweetAlert'], function () {
                                        swal(getTextResource('ErrorCaption'), getTextResource('AjaxError') + '\n[frmSoftwareLicence_historyTab.js, load]', 'error');
                                    });
                                }
                            }
