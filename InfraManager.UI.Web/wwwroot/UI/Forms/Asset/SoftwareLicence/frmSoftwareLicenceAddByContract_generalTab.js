define(['knockout', 'jquery', 'ajax', 'dateTimeControl', 'assetForms', 'ui_controls/ListView/ko.ListView.Helpers'], function (ko, $, ajax, dtLib, fhModule, m_helpers) {
    var module = {
        Tab: function (vm) {
            ...
            self.Template = '../UI/Forms/Asset/SoftwareLicence/frmSoftwareLicenceAddByContract_generalTab';
            ...
            self.load = function () {
                ...
                if (!object.LicenceTypeID() && !object.SoftwareLicenceSchemeID()) {
                    object.Count(1);
                    object.LimitInDays(0);
                    object.LicenceTypeID(1);
                    object.SoftwareLicenceSchemeID(null);
                }
            ...
            self.validate = function () {
                ...
                if (object.ProductCatalogTemplate() == self.ProductCatalogTemplateIDRent) {
                    if (!object.BeginDate()) {
                    ...
                    if (!object.EndDate()) {
                        require(['sweetAlert'], function () {
                            swal(getTextResource('EndDateMustBeSet'));
                        });
                        return false;
                    }
                }

                if (self.IsLimitInDaysVisible() && !object.LimitInDays()) {
                    require(['sweetAlert'], function () {
                        swal(getTextResource('SoftwareLicence_LimitInDaysMustBeSet'));
                    });
                    return false;
                }

                if (!object.SoftwareLicenceSchemeID()) {
                    require(['sweetAlert'], function () {
                        swal(getTextResource('SoftwareLicence_SchemeMustBeSet'));
                    });
                    return false;
                }
            ...
            //Редактирование (выбор) Типа продукта
            self.EditProductCatalogType = function () {
                require(['ui_forms/Asset/SoftwareLicence/frmSoftwareLicenceProductCatalog'], function (jsModule) {
                    jsModule.ShowDialog(
                        function (productCatalogType) {
                            if (!productCatalogType)
                                return;

                            var object = vm.object();
                            object.ProductCatalogTypeID(productCatalogType.ID);
                            object.ProductCatalogTypeName(productCatalogType.Name);
                            object.ProductCatalogTemplate(productCatalogType.ProductCatalogTemplateID);
                        });
                });
            }
                ...
                require(['ui_forms/Asset/AssetOperations/templateParamsUpdate/frmSoftwareTableSelectorModel'], function (fhModule) {
                    var form = new fhModule.Form(
                        ...
                        function (softwareModel) {
                            ...
                            //Производитель ПО
                            object.ManufacturerID(softwareModel.ManufacturerID);
                            object.ManufacturerName(softwareModel.ManufacturerName);
                        },
                        false,
                        self.$region);
                    form.Show();
            ...
            self.IsSoftwareModelChosen = ko.computed(function () {
                var object = vm.object();
                return object && object.SoftwareModelID();
            });
                ...
                require(['usualForms'], function (module) {
                    ...
                    var options = {
                        ...
                        onSave: function (newDate) {
                            ...
                            object.BeginDate(dtLib.Date2String(object.BeginDateDT(), true));
                        },
                        nosave: true
                    };
                ...
                require(['usualForms'], function (module) {
                    ...
                    var options = {
                        ...
                        onSave: function (newDate) {
                            ...
                            object.EndDate(dtLib.Date2String(object.EndDateDT(), true));
                        },
                        nosave: true
                    };
                    fh.ShowSDEditor(fh.SDEditorTemplateModes.dateEdit, options);
            ...
            {//licence type
                ...
                self.selectedLicenceType_handle = self.selectedLicenceType.subscribe(function (licenceType) {
                    var object = vm.object();
                    object.LicenceTypeID(licenceType.ID);
                });
            ...
            {//licence scheme
                ...
                self.selectedLicenceScheme_handle = self.selectedLicenceScheme.subscribe(function (licenceScheme) {
                    var object = vm.object();
                    object.SoftwareLicenceSchemeID(licenceScheme.ID);
                });
                        ...
                        function (result) {
                            if (result) {
                                ...
                                result.forEach(function (el) {
                                    ...
                                    //
                                    var object = vm.object();
                                    if (object.SoftwareLicenceSchemeID() === el.ID)
                                        selEl = el;
                                });
                    ...
                    fh.ShowSoftwareLicenceSchemeLink(
                        ...
                        function (newValues) {
                            ...
                            if (newValues.length == 1) {
                                ...
                                if (model.IsLocationRestrictionApplicable === true) {
                ...
                require(['usualForms'], function (fhModule) {
                    ...
                    var options = {
                        ...
                        onSave: function (newCount) {
                            ...
                            object.SoftwareUsageNoLimits(false);
                        },
                        nosave: true
                    };
            ...
            //editors
            {
                ...
                //редактирование поля "Аппаратный ключ"
