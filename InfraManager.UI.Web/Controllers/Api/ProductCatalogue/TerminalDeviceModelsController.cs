...
public class TerminalDeviceModelsController
{
    private readonly ITerminalDeviceModelBLL _service;

    public TerminalDeviceModelsController(ITerminalDeviceModelBLL service)
    {
        _service = service;
    }

    [HttpGet]
    public Task<ProductModelDetails[]> ListAsync(
        [FromQuery] ProductModelListFilter filterBy,
