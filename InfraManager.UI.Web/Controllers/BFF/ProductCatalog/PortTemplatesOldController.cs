...
[Authorize]
[ApiController]
[Route("bff/ProductCatalog/PortTemplates")]
public class PortTemplatesOldController:ControllerBase
{
    private readonly IPortTemplatesBLL _portTemplatesBLL;

    public PortTemplatesOldController(IPortTemplatesBLL portTemplatesBLL)
    {
