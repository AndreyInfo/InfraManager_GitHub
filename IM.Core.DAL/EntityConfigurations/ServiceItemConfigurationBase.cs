...
public abstract class ServiceItemConfigurationBase : IEntityTypeConfiguration<ServiceItem>
{
    ...
    protected abstract void ConfigureDataBase(EntityTypeBuilder<ServiceItem> builder);
}
