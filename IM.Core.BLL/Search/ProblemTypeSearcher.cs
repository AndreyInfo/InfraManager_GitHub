...
{
    internal class ProblemTypeSearcher : JsonCriteriaObjectSearcher<SearchCriteria>
    {
        private readonly IProblemTypeSearchQuery _query;

        public ProblemTypeSearcher(
            IProblemTypeSearchQuery query,
