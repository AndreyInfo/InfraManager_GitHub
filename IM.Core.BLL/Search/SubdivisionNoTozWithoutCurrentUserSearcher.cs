...
{
    internal class SubdivisionNoTozWithoutCurrentUserSearcher : JsonCriteriaObjectSearcher<SubdivisionSearchCriteria>
    {
        private readonly ISubdivisionSearchQuery _query;

        public SubdivisionNoTozWithoutCurrentUserSearcher(
