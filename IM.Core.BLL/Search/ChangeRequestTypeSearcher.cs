...
{
    internal class ChangeRequestTypeSearcher : JsonCriteriaObjectSearcher<SearchCriteria>
    {
        private readonly IChangeRequestTypeSearcherQuery _query;

        public ChangeRequestTypeSearcher(
            IChangeRequestTypeSearcherQuery query,
