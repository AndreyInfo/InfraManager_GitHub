...
namespace InfraManager.BLL.Notification.Templates
{
    ...
    public class NegotiationTemplate : ITemplate<Negotiation>
    {
        public Guid ID { get; set; }

        [TemplateParameter("Тема согласования")]
        public string Name { get; set; }
        [TemplateParameter("Режим согласования")]
        public string ModeString { get; set; }
        [TemplateParameter("Статус согласования")]
        public string StatusString { get; set; }
        [TemplateParameter("Когда начато согласование")]
        public string DateVoteStartString { get; set; }
        [TemplateParameter("Когда окончено согласование")]
        public string DateVoteEndString { get; set; }
        [TemplateParameter("Адрес Web сервера СервисДеска")]
        public string WebServerAddress { get; set; }
        [TemplateParameter("Адрес согласования")]
        ...
        [TemplateParameter("С чем сязано задание")]
