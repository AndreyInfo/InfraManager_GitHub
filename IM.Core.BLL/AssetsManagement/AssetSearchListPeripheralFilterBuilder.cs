...
internal class AssetSearchListPeripheralFilterBuilder : AssetSearchListFilterBuilder<Peripheral, PeripheralType>
{
    public AssetSearchListPeripheralFilterBuilder(
        IValidateObjectPermissions<Guid, Peripheral> permissionValidator,
    ...
    protected override IEnumerable<Expression<Func<Peripheral, string>>> GetSearchProperties()
    {
    ...
    protected override Expression<Func<Peripheral, bool>> BuildLocationPredicate(Guid locationID, ObjectClass locationClass)
    {
