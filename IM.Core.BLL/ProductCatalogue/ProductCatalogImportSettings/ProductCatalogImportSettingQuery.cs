...
public class ProductCatalogImportSettingQuery : IBuildEntityQuery<ProductCatalogImportSetting,
        ProductCatalogImportSettingOutputDetails, ProductCatalogImportSettingFilter>,
    ISelfRegisteredService<IBuildEntityQuery<ProductCatalogImportSetting, ProductCatalogImportSettingOutputDetails,
        ProductCatalogImportSettingFilter>>
{
    ...
    public IExecutableQuery<ProductCatalogImportSetting> Query(ProductCatalogImportSettingFilter filter)
    {
