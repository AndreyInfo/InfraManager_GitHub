...
internal sealed class MoveCommand : LifeCycleCommand
{
    ...
    public MoveCommand(IMapper mapper
    ...
    {
        var commandResult = await _executor.Map(LifeCycleOperationCommandType.Move).ExecuteAsync(id, data, cancellationToken);
