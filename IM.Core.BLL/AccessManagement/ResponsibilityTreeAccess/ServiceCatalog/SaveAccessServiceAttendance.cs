...
internal sealed class SaveAccessServiceAttendance : SaveAccessServiceCatalogAbstract<ServiceAttendance>
{
    protected override ObjectClass ClassID => ObjectClass.ServiceAttendance;
    protected override IReadOnlyCollection<ObjectClass> ChildClasses => Array.Empty<ObjectClass>();

    public SaveAccessServiceAttendance(IRepository<ObjectAccess> objectAccesses
        , IMapper mapper
