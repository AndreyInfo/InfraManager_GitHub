...
namespace IM.Core.Import.BLL.Ldap.LDAPPages
{
    //взято из https://github.com/metacube/PagedResultsControl
    public class LdapPagedResultsControl: LdapControl
    {
        ...
        public LdapPagedResultsControl(int size, byte[]? cookie) : base(RequestOid, true, null)
        {
            Size = size;
