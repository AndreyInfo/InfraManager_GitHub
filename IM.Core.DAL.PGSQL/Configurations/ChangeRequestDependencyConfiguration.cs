...
namespace InfraManager.DAL.Postgres.Configurations
{
    ...
    {
        protected override string PrimaryKeyName => "pk_rfc_dependency";

        protected override void ConfigureDatabase(
            EntityTypeBuilder<ChangeRequestDependency> builder)
        {
            builder.ToTable("rfc_dependency", Options.Scheme);
            ...
            builder.Property(x => x.OwnerObjectID).HasColumnName("rfc_id");
