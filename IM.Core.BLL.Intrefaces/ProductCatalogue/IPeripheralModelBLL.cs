...
/// <summary>
/// Бизнес логика работы с Периферийными Устройствами (<see cref="ObjectClass.PeripherialModel"/>)
/// </summary>
public interface IPeripheralModelBLL
{
    /// <summary>
    /// Получить список элементов Периферийное Устройство, удовлетворяющих заданному фильтру, асинхронно.
    /// </summary>
    ...
    /// <summary>
    /// Получить Периферийное Устройство по заданному идентификатору асихронно.
    /// </summary>
