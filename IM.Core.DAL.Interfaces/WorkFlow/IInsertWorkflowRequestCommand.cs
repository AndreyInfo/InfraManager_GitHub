...
{
    /// <summary>
    /// Этот интерфейс описывает команду добавления WorkflowRequest
    /// (не нужно это копипастить и использовать в обычных задачах, этот сервис обслуживает костыль в WE)
    /// </summary> 
    public interface IInsertWorkflowRequestCommand
    {
        /// <summary>
        /// Удаляет WorkflowRequest в автономной транзакции
        /// </summary>
