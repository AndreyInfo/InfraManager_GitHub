-- FUNCTION: public.func_access_is_granted(integer, uuid, uuid, integer, integer, boolean)

-- DROP FUNCTION IF EXISTS public.func_access_is_granted(integer, uuid, uuid, integer, integer, boolean);
