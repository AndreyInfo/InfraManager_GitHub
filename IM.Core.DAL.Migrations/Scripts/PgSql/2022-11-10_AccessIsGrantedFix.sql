-- FUNCTION: im.func_access_is_granted(integer, uuid, uuid, integer, integer, boolean)

-- DROP FUNCTION IF EXISTS im.func_access_is_granted(integer, uuid, uuid, integer, integer, boolean);
